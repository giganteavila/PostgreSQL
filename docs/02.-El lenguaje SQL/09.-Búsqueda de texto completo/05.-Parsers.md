...
The built-in parser is named `pg_catalog.default`. It recognizes 23 token types, shown in [Table 12.1](https://www.postgresql.org/docs/current/textsearch-parsers.html#TEXTSEARCH-DEFAULT-PARSER).
